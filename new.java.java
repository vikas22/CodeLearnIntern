			...
			button.addSelectionListener(new SelectionAdapter() {
				...
				public void widgetSelected(SelectionEvent e) {
					...
					try
					{
						...
						PrintWriter writer = new PrintWriter("c:\\sam\\test_in.txt", "UTF-8");
						writer.println(SenderEmail.getText());
						writer.println(Subject.getText());
						writer.close();
						
						 Process p=Runtime.getRuntime().exec("cmd /c start cmd.exe  /K \"javac c:/sam/Helloworld.java && java -cp c:/sam/ Helloworld\"");
